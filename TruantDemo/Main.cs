...
namespace TruantDemo
{
	class MainClass
	{
		...
		public static bool assignResponseCallback(byte channel, Truant.MessageType messageID)
		{
			...
			if (messageID == MessageType.RESPONSE_EVENT_ID) {
				...
				if (arMessageID == MessageType.NETWORK_KEY_ID &&
					...
					AntInternal.ANT_SetChannelPeriod (CHANNEL_NO, 8070);
		...
		public static bool channelEventCallback (byte channel, ResponseStatus channelEvent)
		{
		...
		public static void Main (string[] args)
		{
			...
			AntInternal.ANT_RequestMessage (CHANNEL_NO, MessageType.CHANNEL_ID_ID);
