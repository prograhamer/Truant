...
namespace Truant
{
	internal class AntInternal
	{
		...
		[DllImport("libANT")]
		unsafe public static extern void ANT_AssignResponseFunction(AssignResponseDelegate pfResponse, byte* pucResponseBuffer);
		[DllImport("libANT")]
		unsafe public static extern void ANT_AssignChannelEventFunction(byte ucLink, ChannelEventDelegate pfLinkEvent, byte* pucRxBuffer);
		[DllImport("libANT")]
